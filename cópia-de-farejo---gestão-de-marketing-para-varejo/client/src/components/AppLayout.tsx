...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <aside
        className="hidden lg:flex flex-col flex-shrink-0 fixed top-0 left-0 bottom-0 z-40 shadow-[4px_0_24px_rgba(0,0,0,0.4)] overflow-visible"
        style={{
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-16 z-[70] w-7 h-7 rounded-full border-2 flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-110"
          style={{
